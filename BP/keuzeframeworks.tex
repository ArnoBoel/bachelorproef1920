...
In de lijst kan de aandachtige lezer ook .NET MAUI zien staan, ook al wordt dit framework niet afgetoetst aan de eisen die aan de frameworks gesteld worden. Dit komt doordat .NET MAUI nog maar zeer recent is uitgebracht en nog geen stabiele release heeft. Indien bij de beslissing enkel hier rekening mee wordt gehouden is .NET MAUI geen goede optie om op dit moment op in te zetten. Er wordt echter gezocht naar een framework dat voor de komende jaren de beste keuze is. Gezien de partnership van delaware met Microsoft, de reeds grote aanwezige kennis van .NET binnen het team en de beloftes die Microsoft reeds gemaakt heeft over de plannen met het framework is het een zeer interessant framework om toch mee te nemen in deze vergelijking.
