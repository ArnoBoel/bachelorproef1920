...
Indien een React component een geüpdatete state krijgt gaat de component zijn render functie opnieuw aanroepen en wordt de component dus getoond met de weergave van de nieuwe state. Een widget van Flutter werkt op exact dezelfde manier: een güpdatet state object zorgt ervoor dat de widget zijn eigen build functie opnieuw gaat aanroepen en de nieuwe state wordt weergegeven.
